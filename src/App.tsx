...
const TRACKS: Track[] = [
  {
    ...
    cover: 'Cyfral-site/Треки+обложки/Дерьмо/Дерьмо.jpg',
    audio: 'Cyfral-site/Треки+обложки/Дерьмо/LIL CYFRAL, frogboi — Дерьмо (www.lightaudio.ru).mp3',
  ...
  },
  {
    ...
    cover: 'Cyfral-site/Треки+обложки/FL STUDIO DISS/FL STUDIO DISS.jpg',
    audio: 'Cyfral-site/Треки+обложки/FL STUDIO DISS/KOMERSS, RJK, Lil Cyfral, SSinner31 — FL STUDIO DISS (www.lightaudio.ru).mp3',
  ...
  },
  {
    ...
    cover: 'Cyfral-site/Треки+обложки/FL diss/FL_diss.jpg',
    audio: 'Cyfral-site/Треки+обложки/FL diss/LIL CYFRAL, RJK, ssinner31 — Fl Diss (feat. Shelby) (www.lightaudio.ru).mp3',
  ...
  },
  {
    ...
    artists: 'LIL CYFRAL',
    cover: 'Cyfral-site/Треки+обложки/Лига АШАНного интернета/Лига_АШАНного_интернета.png',
    audio: 'Cyfral-site/Треки+обложки/Лига АШАНного интернета/LIL CYFRAL — Лига АШАНного интернета (www.lightaudio.ru).mp3',
  ...
  },
  {
    ...
    cover: 'Cyfral-site/Треки+обложки/Ашан-монстры/Ашан-монстры.jpg',
    audio: 'Cyfral-site/Треки+обложки/Ашан-монстры/lil cyfral, RJK — Ашан-монстры (www.lightaudio.ru).mp3',
  ...
  },
  {
    ...
    cover: 'Cyfral-site/Треки+обложки/Auchan/Ашан.jpg',
    audio: 'Cyfral-site/Треки+обложки/Auchan/Auchan.mp3',
  ...
  },
  {
    ...
    name: 'LIL CYFRAL$i$',
    artists: 'LIL CYFRAL',
    cover: 'Cyfral-site/Треки+обложки/Lil Cyfral$i$/Lil Cyfral$i$.jpg',
    audio: 'Cyfral-site/Треки+обложки/Lil Cyfral$i$/Lil Cyfral$i$.mp3',
    yandex: null,
    spotify: null,
    apple: null,
    vk: null,
  ...
  },
  {
    ...
    cover: "Cyfral-site/Треки+обложки/MOLODES'H CYPHER 2/MOLODES'H CYPHER 2.jpg",
    audio: "Cyfral-site/Треки+обложки/MOLODES'H CYPHER 2/ИП CHUGUN, Eletr, Hidji 17, LIL CYFRAL, проснулся счастливым, Shelby, Ione, Rouge_Frelon — MOLODES'H CYPHER 2 (www.lightaudio.ru).mp3",
...
const TRACK_FOLDER_MAP: Record<string, string> = {
  'dermo': 'Cyfral-site/Треки+обложки/Дерьмо',
  'fl-studio-diss': 'Cyfral-site/Треки+обложки/FL STUDIO DISS',
  'fl-diss': 'Cyfral-site/Треки+обложки/FL diss',
  'liga': 'Cyfral-site/Треки+обложки/Лига АШАНного интернета',
  'ashan-monstry': 'Cyfral-site/Треки+обложки/Ашан-монстры',
  'auchan': 'Cyfral-site/Треки+обложки/Auchan',
  'lil-cyfral-is': 'Cyfral-site/Треки+обложки/Lil Cyfral$i$',
  'molodesh-cypher': "Cyfral-site/Треки+обложки/MOLODES'H CYPHER 2",
};
